...
<div id="enrollment-applications-container-base">
  ...
  <div id="enrollment-table-container">
    <span id="enrollment-applications-container-base-header">Updated Enrolment Applications<small id="enrolemt-application-updated-at"><i class="fi fi-rr-calendar"></i> Latest update: <?php echo date('m/d/y'); ?></small></span>
    <div id="sort-div">
