...
<div id="enrollment-applications-container-base">
  ...
  <div id="enrollment-table-container">
    ...
    <span id="enrollment-applications-container-base-header">Closed Threads<small id="enrolemt-application-updated-at"><i class="fi fi-rr-calendar"></i> Latest update: <?php echo date('m/d/y'); ?></small></span>
    ...
    <div id="search-table" class="form-field">
        ...
        <a href="{{route('admin.issue_reports.index') }}" id="refresh"><i class="fa fa-warning"></i>Open Thereads</a>
           ...
           <td>
              ...
              <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2" role="group" aria-label="First group">
                  <a class="btn btn-md btn-danger" href="{{route('admin.issue_reports.edit',$issue->id) }}" role="button">Mark as Unsolved</a>
                      <a class="btn btn-md btn-warning" href="{{route('admin.issue_reports_view.show',$issue->id) }}" role="button">View Thread</a>
                  <a class="btn btn-md btn-secondary" href="{{route('admin.users.show',$issue->user_id) }}" role="button">View</a>
