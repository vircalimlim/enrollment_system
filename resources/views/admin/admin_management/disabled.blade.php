...
<div id="enrollment-applications-container-base">
  ...
  <div id="enrollment-table-container">
    ...
    <span id="enrollment-applications-container-base-header">Disabled BNHS Enrolment System Administrators<small id="enrolemt-application-updated-at"><i class="fi fi-rr-calendar"></i> Latest update: <?php echo date('m/d/y'); ?></small></span>
        <div id="sort-div">
            ...
            <td>
              ...
              <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2" role="group" aria-label="First group">
                  ...
                  <a class="btn btn-md btn-success" href="{{route('admin.management.show',$user->id) }}" role="button">Enable</a>
